...
"""
Parametros par ala el entrenamiento
"""
epocas=20
...
cnn.save('./modelo/modelo_completo.keras')

# Si realmente necesitas solo los pesos por separado:
#ahora tiene que acabar en .weights.h5 si no te dice que nana
